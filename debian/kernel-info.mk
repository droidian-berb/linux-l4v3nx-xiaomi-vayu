...
KERNEL_CONFIG_EXTRA_FRAGMENTS = vayu-optimizations.config vayu-droidian.config vayu-halium.config vayu-security.config container.config #vayu-halium-extended.config
