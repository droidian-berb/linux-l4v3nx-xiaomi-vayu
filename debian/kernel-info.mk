...
KERNEL_CONFIG_EXTRA_FRAGMENTS = vayu-optimizations.config vayu-droidian.config vayu-halium.config container.config #vayu-halium-lxc.config vayu-halium-net.config vayu-halium-security.config 
